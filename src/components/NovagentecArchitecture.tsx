export default function NovagentecArchitecture() {
  return (
    <div className="bg-[#0a0a0a] text-[#f3f2ee] min-h-screen font-sans selection:bg-gray-700">
      ...
      <section className="relative px-6 py-24 md:py-32 lg:px-8 max-w-7xl mx-auto flex flex-col justify-center border-b border-gray-800">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="px-8 py-4 bg-white text-black font-semibold tracking-wide uppercase text-sm hover:bg-gray-200 transition-colors duration-200">
              Explore Our Approach →
            </button>
            <button className="px-8 py-4 bg-transparent border border-gray-600 text-white font-semibold tracking-wide uppercase text-sm hover:border-gray-400 transition-colors duration-200">
      ...
      <section className="px-6 py-24 lg:px-8 max-w-7xl mx-auto">
